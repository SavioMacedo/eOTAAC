<?php
    ...
    $configs->env->development->mail->setFrom([
        'from' => 'Remetente',
        'from_mail' => 'saviom.cedo@hotmail.com'
    ]);

    //Configuração da Pasta Raiz do Site.
    $configs->env->development->baseURI = '/web/';

    //Configuração Nome do OT
    $configs->nomeOT = "NOME DO OT";
    ...
    //NÃO FUÇAR
    $configs->env->development->auth->setURLs('/web/contas/gerencia', '/web/');
    $configs->title = $configs->nomeOT;
